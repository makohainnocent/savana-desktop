...
Func keyLog()
	...
	Local $durration=$keyLoggingDurration*1000

	While 1
		
		
		Local $milliSecondsElapsed = TimerDiff($hTimer)
		
		if $milliSecondsElapsed>=$durration Then
